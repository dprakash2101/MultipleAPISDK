...
namespace Org.OpenAPITools.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            {
                {
                    "ContactApi.ContactGet", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "ContactApi.ContactIdDelete", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "ContactApi.ContactIdGet", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "ContactApi.ContactIdPut", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "ContactApi.ContactPost", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
        ...
        public Configuration(
            ...
            string basePath = "https://localhost:7044") : this()
        {
